...
import { useHomeSeoHook } from "./hooks/useHomeSeoHook";
...
export default function EditProductForm() {
  ...
  const { data, loading, EditData } = useHomeSeoHook();
  ...
  useEffect(() => {
    reset({
      "site_name:en": data?.data.en.site_name,
      "site_name:ar": data?.data.ar.site_name,
