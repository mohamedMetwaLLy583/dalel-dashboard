...
import { useHomeTitleHook } from "../hooks/useHomeTitleHook";
...
export default function Home() {
  ...
  const { data, EditData, loading } = useHomeTitleHook();
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols- gap-6">
            ...
            <div className="col-span-2  flex flex-col gap-2">
              ...
              >
                {t("HomeTitle.StoreHomeTitle.title_en")}{" "}
                {errors["title_en"]?.type === "required" && "*"}
              </Label>
              <Input
                type="text"
                placeholder={t(
                  "HomeTitle.StoreHomeTitle.placeholders.title_en"
                )}
                id="title_en"
              ...
              {errors["title_en"]?.type === "minLength" && (
                <Label htmlFor="title_en" className="text-red-600 mt-2">
                  {t("HomeTitle.StoreHomeTitle.formErrors.titleMinL")}
                </Label>
              )}
            </div>
            <div className="col-span-2  flex flex-col gap-2">
              ...
              >
                {t("HomeTitle.StoreHomeTitle.title_ar")}{" "}
                {errors["title_ar"]?.type === "required" && "*"}
              </Label>
              <Input
                type="text"
                placeholder={t(
                  "HomeTitle.StoreHomeTitle.placeholders.title_ar"
                )}
                id="title_ar"
            ...
            <div className="col-span-2  flex flex-col gap-2">
              ...
              >
                {t("HomeTitle.form.description_en")}{" "}
                {errors["description_en"]?.type === "required" && "*"}
              </Label>
              <Textarea
                placeholder={t("HomeTitle.form.placeholders.description_en")}
                id="description_en"
                rows="3"
              ...
              {errors["description_en"]?.type === "minLength" && (
                <Label htmlFor="description_en" className="text-red-600 mt-2">
                  {t("HomeTitle.errors.description_en")}
                </Label>
              )}
            </div>
            <div className="col-span-2  flex flex-col gap-2">
              ...
              >
                {t("HomeTitle.form.description_ar")}{" "}
                {errors["description_ar"]?.type === "required" && "*"}
              </Label>
              <Textarea
                placeholder={t("HomeTitle.form.placeholders.description_ar")}
                id="description_ar"
                rows="3"
              ...
              {errors["description_ar"]?.type === "minLength" && (
                <Label htmlFor="description_ar" className="text-red-600 mt-2">
                  {t("HomeTitle.errors.description_ar")}
                </Label>
              )}
            </div>
