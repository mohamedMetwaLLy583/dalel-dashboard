...
export default function ChooseUsTable() {
  const { data, deleteData, loading, deletingId } = useChooseUsHook();
  const t = useTranslations();
  const columns = [
    {
      key: "Image",
      label: t("ChooseUs.table.image"),
    },
    {
      key: "Title",
      label: t("ChooseUs.table.title"),
    },
    {
      key: "Descriprion",
      label: t("ChooseUs.table.Desc"),
    },

    {
      key: "action",
      label: t("ChooseUs.table.action"),
    },
  ];
                  ...
                  {deletingId === item.id ? (
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" avoidCollisions>
                        <DropdownMenuLabel>
                          {t("ChooseUs.table.ActionCenter.title")}
                        </DropdownMenuLabel>
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(`edit-choose-us/${item.id}`)
                          }
                        >
                          <Icon
                          ...
                          />
                          {t("ChooseUs.table.ActionCenter.edit")}
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  )}
